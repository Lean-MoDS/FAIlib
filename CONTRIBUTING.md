# Contributing to FAIlib

Thank you for contributing to FAIlib. Please open an issue before beginning a large formalization
...
- Reuse existing FAIlib and Mathlib declarations before adding new infrastructure.
