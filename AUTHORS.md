...
**Copyright in FAIlib is held by the individual copyright holders identified in the source
...
The [published FAIlib website](https://lean-mods.github.io/FAIlib/) identifies project authors in
...
The [Git history](https://github.com/Lean-MoDS/FAIlib/commits/main) records repository
...
Unless explicitly stated otherwise, contributions intentionally submitted for inclusion in FAIlib
