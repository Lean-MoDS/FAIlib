...
-/
import FAIlib.LearningTheory.EmpiricalProcess.Metric
import FAIlib.Topology.MetricSpace.CoveringNumber.Basic
...
metric structure are induced from FAIlib's canonical empirical space.
...
/-- The sample-indexed view of FAIlib's canonical empirical norm. -/
